...
input_path = '/Users/danbenzvi/Desktop/dan_nadav_game/dan_and_nadav_game/dan/images/table-15.jpg'  # שנה לנתיב התמונה הקלט שלך
output_path = '/Users/danbenzvi/Desktop/dan_nadav_game/dan_and_nadav_game/dan/output/white/table-15.jpg'  # שנה לנתיב התמונה הפלט הרצויה
...
if circles is not None:
    ...
    for (x, y, r) in circles:
        ...
        # סנן אם כהה מדי (לא רלוונטי לכדור לבן, אבל שמור לסינון כיסים אם צריך)
        if intensity < 20:  # סף כהות, התאם אם צריך
            continue
        
        # בדוק אם זה הכדור הבהיר ביותר
